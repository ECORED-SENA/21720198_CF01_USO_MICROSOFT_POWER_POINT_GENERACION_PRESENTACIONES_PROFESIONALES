    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      .titulo-principal.color-acento-contenido(data-aos="flip-up")
        .titulo-principal__numero
          span 4
        h1 Aplicación de temas, estilos, diseños prediseñados y plantillas
      .row.bg-c23
        .col-12
          .px-5
            .row
            ...
            .titulo-segundo.color-acento-contenido(data-aos="flip-up")
              h2 4.1 Configuración del tamaño y formato de diapositivas
                ...
                .p-4.bg-c20.h-100
                  .row.align-items-center
                    .col-md-auto.mb-4.mb-md-0
                      figure
                        img(src="@/assets/curso/tema4/img2.svg", alt="", style="width: 60px;").m-auto
                    .col-md
                    ...
                    .col-12
                      ...
                      ul.lista-ul--color.ms-5
                        li.d-flex
                          ...
                          |
                          p.mb-0 Algunos temas incorporan estilos de fondo y variantes cromáticas que permiten modificar la apariencia general sin perder coherencia estructural.
                        li.d-flex
                          i.fas.fa-arrow-circle-right
                          |
            ...
            .row.align-items-center
              ...
              .col-lg-7(data-aos="fade-left")
                ...
                .row
                  .col-12
                    .p-4.bg-c13
                      p #[b Tip:] antes de aplicar un tema en una presentación definitiva, conviene revisar cómo se comportan títulos, tablas, gráficos e imágenes en varias diapositivas, verificando contraste, equilibrio visual y legibilidad.
      Separador
      .row.bg-c24
        .col-12
          .px-5
            ...
            .row.align-items-center.mb-4
              .col-lg-4.mb-4.mb-lg-0(data-aos="fade-right")
                figure
                  img(src="@/assets/curso/tema4/img11.png", alt="", style="width: 340px;").m-auto
              .col-lg-8(data-aos="fade-left")
                SlyderF.circl-arrow(columnas="col-md-6")
                  .tarjeta.color-primario1.p-4
                    .row.justify-content-center.mb-3
                      .col-6
                        img(src='@/assets/curso/tema4/img6.svg' alt='')
                    p.text-center #[b Diapositiva maestra]
                    p.text-center Es la estructura principal desde la cual se controlan estilos generales y diseños secundarios de toda la presentación.
                  .tarjeta.color-primario1.p-4
                    .row.justify-content-center.mb-3
                      .col-6
                        img(src='@/assets/curso/tema4/img7.svg' alt='')
                    p.text-center #[b Uniformidad visual]
                    p.text-center Garantiza consistencia en títulos, tipografías, colores, logotipos, fondos y ubicación de objetos en todas las diapositivas.
                  .tarjeta.color-primario1.p-4
                    .row.justify-content-center.mb-3
                      .col-6
                        img(src='@/assets/curso/tema4/img8.svg' alt='')
                    p.text-center #[b Ahorro de tiempo]
                    p.text-center Permite aplicar cambios globales de forma automática, reduciendo procesos repetitivos de edición.
                  .tarjeta.color-primario1.p-4
                    .row.justify-content-center.mb-3
                      .col-6
                        img(src='@/assets/curso/tema4/img9.svg' alt='')
                    p.text-center #[b Trabajo colaborativo]
                    p.text-center Facilita que distintos usuarios elaboren presentaciones bajo los mismos lineamientos gráficos.
                  .tarjeta.color-primario1.p-4
                    .row.justify-content-center.mb-3
                      .col-6
                  ...
                  .tarjeta.color-primario1.p-4
                    ...
                    p.text-center #[b Marcadores de posición]
                    p.text-center Define espacios predeterminados para títulos, textos, imágenes, tablas o gráficos, manteniendo orden estructural.
                  .tarjeta.color-primario1.p-4
                    .row.justify-content-center.mb-3
                      .col-6
                        img(src='@/assets/curso/tema4/img12.svg' alt='')
                    p.text-center #[b Escalabilidad]
                    p.text-center Resulta útil para organizaciones que producen múltiples presentaciones de manera frecuente.
            .row.align-items-center.mb-4
              .col-lg-auto.mb-4.mb-lg-0(data-aos="fade-right")
                figure
                  img(src="@/assets/curso/tema3/img3.svg", alt="", style="width: 100px;").m-auto
              .col-lg(data-aos="fade-left")
                p.mb-0 A continuación, se presenta el procedimiento general para crear y configurar plantillas maestras dentro de la herramienta.
            figure
              .video
                iframe(width="560" height="315" src="https://www.youtube.com/embed/z1PMmZznvyY?si=xF-UbJ38miGSa6IZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
